...
<img src="./public/Ballot-2.webp" alt="Ballot App image generated by ChatGPT" width="50%" height="auto">
...
> [!NOTE]
> This repository contains a smart contract project based on [Solidity by Example](https://docs.soliditylang.org/en/v0.8.25/solidity-by-example.html). I have adapted and expanded the original examples to deepen my understanding of Solidity and to add comprehensive test coverage.
